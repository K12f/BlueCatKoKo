...
public class KuaiShouShareVideoData
{
    ...
    [JsonProperty("shareInfo")] public ShareInfo ShareInfo { get; set; }
    ...
    [JsonProperty("trendingInfo")] public TrendingInfo TrendingInfo { get; set; }

    [JsonProperty("mp4Url")] public Uri Mp4Url { get; set; }

    [JsonProperty("photos")] public List<Photo> Photos { get; set; }

    [JsonProperty("shareUserPhotos")] public List<object> ShareUserPhotos { get; set; }

    [JsonProperty("serialInfo")] public SerialInfo SerialInfo { get; set; }
}
...
public class Comment
{
    ...
    [JsonProperty("cashTags")] public CashTags CashTags { get; set; }

    [JsonProperty("commentAuthorTags")] public List<object> CommentAuthorTags { get; set; }

    [JsonProperty("photo_id")] public double PhotoId { get; set; }

    [JsonProperty("headurl")] public Uri Headurl { get; set; }

    [JsonProperty("headurls")] public List<CoverUrl> Headurls { get; set; }

    [JsonProperty("author_liked")] public bool AuthorLiked { get; set; }

    [JsonProperty("type")] public long Type { get; set; }

    [JsonProperty("comment_id")] public long CommentId { get; set; }

    [JsonProperty("authorVerified")] public bool AuthorVerified { get; set; }
    ...
    [JsonProperty("commentBottomTags")] public List<object> CommentBottomTags { get; set; }
...
public class Counts
{
    [JsonProperty("fanCount")] public long FanCount { get; set; }

    [JsonProperty("followCount")] public long FollowCount { get; set; }
...
public class Photo
{
    ...
    [JsonProperty("mainMvUrls")] public List<CoverUrl> MainMvUrls { get; set; }
    ...
    [JsonProperty("webpCoverUrls")] public List<CoverUrl> WebpCoverUrls { get; set; }
    ...
    [JsonProperty("coverUrls")] public List<CoverUrl> CoverUrls { get; set; }
...
{
    [JsonProperty("FRPost")] public long FrPost { get; set; }

    [JsonProperty("NR")] public double Nr { get; set; }

    [JsonProperty("NRPost")] public double NrPost { get; set; }

    [JsonProperty("FR")] public double Fr { get; set; }
}

public class PlayInfo
{
    [JsonProperty("strategyBus")] public string StrategyBus { get; set; }
...
{
    [JsonProperty("jpgCdnNodeView")] public List<CoverUrl> JpgCdnNodeView { get; set; }

    [JsonProperty("webpCdnNodeView")] public List<CoverUrl> WebpCdnNodeView { get; set; }
}
...
public class SoundTrack
{
    ...
    [JsonProperty("audioUrls")] public List<CoverUrl> AudioUrls { get; set; }

    [JsonProperty("finalStatus")] public long FinalStatus { get; set; }

    [JsonProperty("avatarUrls")] public List<CoverUrl> AvatarUrls { get; set; }
    ...
    [JsonProperty("imageUrls")] public List<CoverUrl> ImageUrls { get; set; }
...
public class ShareInfo
{
    ...
    [JsonProperty("shareTitle")] public string ShareTitle { get; set; }

    [JsonProperty("docId")] public long DocId { get; set; }

    [JsonProperty("shareId")] public string ShareId { get; set; }

    [JsonProperty("shareType")] public long ShareType { get; set; }

    [JsonProperty("shareSubTitle")] public string ShareSubTitle { get; set; }
}

public class TrendingInfo
{
    [JsonProperty("iconRightMargin")] public long IconRightMargin { get; set; }

    [JsonProperty("preTitle")] public string PreTitle { get; set; }

    [JsonProperty("backgroundColor")] public string BackgroundColor { get; set; }

    [JsonProperty("iconHeight")] public long IconHeight { get; set; }

    [JsonProperty("visibility")] public long Visibility { get; set; }

    [JsonProperty("iconWidth")] public long IconWidth { get; set; }

    [JsonProperty("showSeparator")] public bool ShowSeparator { get; set; }

    [JsonProperty("wordId")] public long WordId { get; set; }

    [JsonProperty("notTruncatedTitle")] public string NotTruncatedTitle { get; set; }

    [JsonProperty("bottomWeakStyleType")] public long BottomWeakStyleType { get; set; }

    [JsonProperty("showArrow")] public bool ShowArrow { get; set; }

    [JsonProperty("title")] public string Title { get; set; }

    [JsonProperty("tailIconUrl")] public string TailIconUrl { get; set; }

    [JsonProperty("roundCorner")] public bool RoundCorner { get; set; }

    [JsonProperty("enableForceClose")] public bool EnableForceClose { get; set; }

    [JsonProperty("fontSize")] public long FontSize { get; set; }

    [JsonProperty("iconUrl")] public Uri IconUrl { get; set; }

    [JsonProperty("fontColor")] public string FontColor { get; set; }
}