...
namespace BlueCatKoKo.Ui.ViewModels
{
    ...
    public partial class MainWindowViewModel : ViewModelBase, IRecipient<ValueChangedMessage<DownloaderMessage>>
    {
        ...
        {
            DownloaderEnum type = message.Value.Type;
            string notifyMessage = message.Value.Message;
            string url = message.Value.Url;
            GrowlInfo growlInfo = new GrowlInfo { Message = notifyMessage, ShowDateTime = true, WaitTime = 2 };
